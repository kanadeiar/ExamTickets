...
public static class ExamTicketsSeedTestData
{
    public static async void SeedTestData(IServiceProvider provider, IConfiguration configuration, ILogger logger)
    {
...

        {
            ...
            await context.SaveChangesAsync();
            var q1 = new Question { QuestionText = "1) В виде каких файлов должны формироваться электронные документы при подготовке отчета о производственном контроле?", Ticket = t};
            var q2 = new Question { QuestionText = "2) В какой срок со дня поступления требования страхователя об изменении условий договора обязательного страхования в связи с уменьшением страхового риска, включая уменьшение размера страховой премии, страховщик обязан рассмотреть такое требование?", Ticket = t};
            var q3 = new Question { QuestionText = "3) В каком случае эксплуатирующая организация вправе разрабатывать единый план мероприятий по локализации и ликвидации последствий аварий на опасных производственных объектах на несколько опасных объектов?", Ticket = t };
            var q4 = new Question { QuestionText = "4) Как называется один из видов деятельности в области промышленной безопасности, подлежащий лицензированию в соответствии с Федеральным законом от 04.05.2011 № 99-ФЗ «О лицензировании отдельных видов деятельности»?", Ticket = t };
            var q5 = new Question { QuestionText = "5) Какие сведения отражаются в заключении экспертизы промышленной безопасности по результатам экспертизы технического устройства?", Ticket = t };
            var q6 = new Question { QuestionText = "6) Какое определение соответствует понятию «авария», изложенному в Федеральном законе от 21.07.1997 № 116-ФЗ «О промышленной безопасности опасных производственных объектов»?", Ticket = t };
            var q7 = new Question { QuestionText = "7) Когда план мероприятий по локализации и ликвидации последствий аварий считается принятым?", Ticket = t };
            var q8 = new Question { QuestionText = "8) Кто утверждает декларацию промышленной безопасности?", Ticket = t };
            var q9 = new Question { QuestionText = "9) При каком условии событие признается страховым случаем?", Ticket = t };
            var q10 = new Question { QuestionText = "10) Что из указанного относится к обязанностям организации в области промышленной безопасности в соответствии с Федеральным законом от 21.07.1997 № 116-ФЗ «О промышленной безопасности опасных производственных объектов»?", Ticket = t };
        ...
        }
        {
            ...
            context.Tickets.Add(t);
            await context.SaveChangesAsync();
            var q1 = new Question { QuestionText = "1) В какие сроки эксплуатирующая организация представляет в Ростехнадзор или его территориальные органы сведения об организации производственного контроля за соблюдением требований промышленной безопасности?", Ticket = t };
            var q2 = new Question { QuestionText = "2) В какой срок эксплуатирующие организации и индивидуальные предприниматели обязаны предоставить в регистрирующий орган сведения, характеризующие опасные производственные объекты?", Ticket = t };
            var q3 = new Question { QuestionText = "3) В каком случае юридическое лицо признается виновным в совершении административного правонарушения?", Ticket = t };
            var q4 = new Question { QuestionText = "4) Как производится ввод в эксплуатацию опасного производственного объекта?", Ticket = t };
            var q5 = new Question { QuestionText = "5) Какие сроки действия планов мероприятий по локализации и ликвидации последствий аварий установлены для объектов I класса опасности (за исключением объектов, на которых ведутся горные работы)?", Ticket = t };
            var q6 = new Question { QuestionText = "6) Какое право не предоставлено должностным лицам Ростехнадзора при осуществлении федерального государственного надзора в области промышленной безопасности?", Ticket = t };
            var q7 = new Question { QuestionText = "7) Когда положение о производственном контроле считается принятым?", Ticket = t };
            var q8 = new Question { QuestionText = "8) Кто утверждает планы мероприятий по локализации и ликвидации последствий аварий на опасных производственных объектах? Выберите два варианта ответа.\nА) Руководитель (заместители руководителей) организаций, эксплуатирующих объекты.\nБ) Руководители профессиональных аварийно - спасательных служб или профессиональных аварийно-спасательных формирований.\nВ) Руководители обособленных подразделений юридических лиц(в случаях, предусмотренных положениями о таких обособленных подразделениях).\nГ) Инспектор Ростехнадзора.\nД) Все ответы неверны.", Ticket = t };
            var q9 = new Question { QuestionText = "9) При строительстве и реконструкции каких объектов капитального строительства осуществляется государственный строительный надзор?", Ticket = t };
            var q10 = new Question { QuestionText = "10) Что не является предметом государственного строительного надзора?", Ticket = t };
            context.Questions.AddRange(q1, q2, q3, q4, q5, q6, q7, q8, q9, q10);
            await context.SaveChangesAsync();
        ...
        }
        {
            ...
            context.Tickets.Add(t);
            await context.SaveChangesAsync();
            var q1 = new Question { QuestionText = "1) В какие федеральные органы исполнительной власти заявитель, предполагающий выполнение работ (оказание услуг) при эксплуатации взрывопожароопасных и химически опасных производственных объектов IV класса опасности, должен представлять уведомления о начале осуществления своей деятельности?", Ticket = t };
            var q2 = new Question { QuestionText = "2) В какой форме осуществляется обязательная оценка соответствия зданий и сооружений, а также связанных со зданиями и с сооружениями процессов эксплуатации?", Ticket = t };
            var q3 = new Question { QuestionText = "3) В отношении каких из перечисленных объектов капитального строительства государственная экспертиза проектов не проводится?", Ticket = t };
            var q4 = new Question { QuestionText = "4) Какая административная ответственность предусмотрена законодательством Российской Федерации за нарушение должностными лицами требований промышленной безопасности или лицензионных требований на осуществление видов деятельности в области промышленной безопасности?", Ticket = t };
            var q5 = new Question { QuestionText = "5) Какие сроки действия планов мероприятий по локализации и ликвидации последствий аварий установлены для объектов II класса опасности (за исключением объектов, на которых ведутся горные работы)?", Ticket = t };
            var q6 = new Question { QuestionText = "6) Какой из перечисленных случаев не может являться основанием для исключения объекта из государственного реестра опасных производственных объектов?", Ticket = t };
            var q7 = new Question { QuestionText = "7) Кому вменена обязанность страховать свою ответственность за причинение вреда в результате аварии на опасном объекте в соответствии с Федеральным законом от 27.07.2010 № 225-ФЗ «Об обязательном страховании гражданской ответственности владельца опасного объекта за причинение вреда в результате аварии на опасном объекте»?", Ticket = t };
            var q8 = new Question { QuestionText = "8) Кто является владельцем опасного объекта в терминологии Федерального закона от 27.07.2010 №225-ФЗ «Об обязательном страховании гражданской ответственности владельцев опасных объектов за причинение вреда в результате аварии на опасном объекте»?", Ticket = t };
            var q9 = new Question { QuestionText = "9) Разработка каких документов в рамках организации документационного обеспечения систем управления промышленной безопасностью не предусмотрена в нормативном правовом акте?", Ticket = t };
            var q10 = new Question { QuestionText = "10) Что обязан сделать лицензиат, если он намерен изменить адрес места осуществления лицензируемого вида деятельности?", Ticket = t };
            context.Questions.AddRange(q1, q2, q3, q4, q5, q6, q7, q8, q9, q10);
            await context.SaveChangesAsync();
        ...
        }
        {
            ...
            context.Tickets.Add(t);
            await context.SaveChangesAsync();
            var q1 = new Question { QuestionText = "1) В каких документах устанавливаются формы оценки соответствия обязательным требованиям к техническим устройствам, применяемым на опасном производственном объекте?", Ticket = t };
            var q2 = new Question { QuestionText = "2) В каком виде допускается представлять сведения об организации производственного контроля за соблюдением требований промышленной безопасности в Ростехнадзор?", Ticket = t };
            var q3 = new Question { QuestionText = "3) В отношении каких объектов предусмотрена разработка планов мероприятий по локализации и ликвидации последствий аварий на опасных производственных объектах?", Ticket = t };
            var q4 = new Question { QuestionText = "4) Какая из перечисленных задач не относится к задачам производственного контроля за соблюдением требований промышленной безопасности на опасном производственном объекте?", Ticket = t };
            var q5 = new Question { QuestionText = "5) Какие сроки действия планов мероприятий по локализации и ликвидации последствий аварий установлены для объектов III класса опасности (за исключением объектов, на которых ведутся горные работы)?", Ticket = t };
            var q6 = new Question { QuestionText = "6) Какой минимальный срок действия лицензии установлен Федеральным законом от 04.05.2011 № 99-ФЗ «О лицензировании отдельных видов деятельности»?", Ticket = t };
            var q7 = new Question { QuestionText = "7) Кто ведет реестр заключений экспертизы промышленной безопасности?", Ticket = t };
            var q8 = new Question { QuestionText = "8) Кто является страхователями гражданской ответственности за причинение вреда в результате аварии на опасном производственном объекте?", Ticket = t };
            var q9 = new Question { QuestionText = "9) С какой периодичностью организация, эксплуатирующая опасные производственные объекты, должна направлять информацию об инцидентах, происшедших на опасных производственных объектах, в территориальный орган Ростехнадзора?", Ticket = t };
            var q10 = new Question { QuestionText = "10) Что обязан сделать лицензиат, если он планирует выполнять работы (оказывать услуги), составляющие лицензируемую деятельность, и не указанные в лицензии?", Ticket = t };
            context.Questions.AddRange(q1, q2, q3, q4, q5, q6, q7, q8, q9, q10);
            await context.SaveChangesAsync();
